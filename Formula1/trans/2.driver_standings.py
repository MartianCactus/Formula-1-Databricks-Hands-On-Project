...
driverStandingsSpec = Window.partitionBy("race_year").orderBy(desc("total_points"), desc("Wins"))
final_df = driver_standings_df.withColumn("rank", rank().over(driverStandingsSpec))
