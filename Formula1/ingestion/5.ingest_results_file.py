...
# MAGIC %md
# MAGIC ###Loading data and applying schema
...
results_final_df = results_ingestion_date_df \
...
#De-duplicating the data due to duplications from source
...
# Consolodating the above 3 blocks into one function
